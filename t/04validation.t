...
is( $result,169050, "Compound statement max(aggregate function with  max) executed and returned value is validated");
...
is(int($result),167348,"Compound statement average(aggregate function with  max) executed and returned value is validated");
