...
is( $result ,2434, " average function return value verified ");
...
# comparing the value returned with actual value
is( $result ,4867, "max function return value verified ");
...
is( $result ,'4624', " percentile function return value verified ");
...
is( $result ,'4381', " percentile function return value verified ");
...
is( $result ,'3894', " percentile function return value verified ");
...
is($result,"87566491","Extrapolate value for input 10/01/1997 00:15:00 UTC is validated");
...
is( $result,4890, "Compound statement max(aggregate function with  max) executed and returned value is validated");
...
is(int($result),3188,"Compound statement average(aggregate function with  max) executed and returned value is validated");
