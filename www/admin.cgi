...
#----- $LastChangedRevision: $
#----- $LastChangedDate: $
#----- $HeadURL: svn+ssh://svn.grnoc.iu.edu/grnoc/tsds/services/trunk/www/admin.cgi $
#----- $Id: admin.cgi 38789 2015-08-21 16:42:38Z prattadi $
#-----
#----- This script is designed to be loaded by Apache + mod_perl and
#----- is just a wrapper to the GRNOC::TSDS::GWS::Admin webservice
#----- library.
#--------------------------------------------------------------------
